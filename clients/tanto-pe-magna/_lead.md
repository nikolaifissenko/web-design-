...
**Send the screenshot with this message, not just the bare link** — a link alone doesn't preview well in an Instagram DM, a screenshot does. Attach `clients/tanto-pe-magna/screenshots/demo-preview.png` (a real screenshot of the live demo, taken 2026-08-26).
