...
- **Found:** 2026-09-08 (manual web search, "restauro/riparazione borse valigie Roma")
- **Address:** Via Conte Verde, 17, 00185 Roma (Esquilino)
...
- **Sold:** no
- **Notes:**
  - Laboratorio di riparazione borse, valigie, trolley e ombrelli all'Esquilino, dal 1902, oggi parte del gruppo Carucci dal 1926. Uno dei pochi laboratori di questo tipo ancora attivi a Roma.
  - **Colori reali**, estratti dal CSS del loro sito (blu navy `#002255` + arancio `#f59331`, usati in modo consistente in tutto il tema).
  - **Nessun logo grafico trovato**, solo testo. `logoText` di fallback, caso legittimo.
...
To: isellaidal1902@gmail.com

Subject: Una proposta per il sito di iSellai dal 1902

> Buongiorno,
>
> mi chiamo Nikolai, sono un web designer freelance qui a Roma. Ho visto il vostro sito e mi è sembrato un peccato che una storia così lunga (dal 1902!) non fosse valorizzata da un sito più moderno, quindi ve ne ho preparato gratuitamente una versione nuova, con lo stesso spirito ma un design più attuale:
>
> https://nikolaifissenko.github.io/web-design-/clients/isellai-dal-1902/
>
